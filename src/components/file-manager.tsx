...
export function FileManager({ initialPath = '/home/v2syp306tne7' }: FileManagerProps) {
    ...
    <div className="h-full flex flex-col bg-background">
      ...
      <div className="flex-1 flex">
        ...
        <div className="w-64 border-r bg-card p-4">
          <h3 className="font-semibold mb-3 text-sm text-muted-foreground uppercase">Folders</h3>
          <div className="space-y-1">
            {sampleFiles.filter(f => f.type === 'folder').map(folder => (
              <div key={folder.id}>
                <button
